...
# 各年龄段的成绩箱型图
age_grade_boxplot = sns.boxplot(x='age', y='G3', data=topas(dfStudentMat))
age_grade_boxplot.axes.set_title('年龄与分数', fontsize = 20)
age_grade_boxplot.set_xlabel('年龄', fontsize = 12)
age_grade_boxplot.set_ylabel('分数', fontsize = 12)
plt.show()
