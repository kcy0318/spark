...
# 失败次数成绩分布图
student = topas(spark.sql('select failures,G3 from mat'))
failures_swarmplot = sns.swarmplot(x=student['failures'],y=student['G3'])
failures_swarmplot.axes.set_title('失败次数少的学生分数更高吗？', fontsize = 20)
failures_swarmplot.set_xlabel('失败次数', fontsize = 12)
failures_swarmplot.set_ylabel('最终成绩', fontsize = 12)
plt.show()