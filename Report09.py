...
# 城乡与成绩分析
sns.kdeplot(topas(dfStudentMat).loc[topas(dfStudentMat)['address'] == 'U', 'G3'], label='Urban', shade=True)
sns.kdeplot(topas(dfStudentMat).loc[topas(dfStudentMat)['address'] == 'R', 'G3'], label='Rural', shade=True)
